...
final class EZEV_Operations_Manual_Provider implements EZEV_Operations_Provider {
    ...
    public function label(): string { return 'Manual Provider'; }
    ...
    public function fetch_connectors(): array { global $wpdb; return $wpdb->get_results("SELECT * FROM ".EZEV_Operations_DB::table('connectors')." ORDER BY station_id,charger_id,connector_id",ARRAY_A)?:[]; }
