...
final class EZEV_Operations {
    ...
    public static function activate(): void { EZEV_Operations_DB::install(); EZEV_Operations_DB::seed_demo(); EZEV_Operations_Sync::schedule(); }
    public static function deactivate(): void { EZEV_Operations_Sync::unschedule(); }
    public function boot(): void { EZEV_Operations_Admin::init(); EZEV_Operations_REST::init(); EZEV_Operations_Sync::init(); add_action('admin_notices',[$this,'dependency_notice']); }
